 ...
 */
export type PlanInterval = PlanIntervals.MONTH | PlanIntervals.YEAR | PlanIntervals.QUARTER;
...
export interface PaymentProvider {
   ...
   * Used for polling payment status when webhook is not received
   */
  getCheckoutSession(sessionId: string): Promise<any | null>;
}
